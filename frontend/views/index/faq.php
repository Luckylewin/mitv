...
<div class="container-fluid phone-btn">
    ...
    <div class="row">
        <div style="margin:30px auto 10px">
            ...
            <a href="<?= Url::to(['index/purchase','app'=>$app->id]) ?>" class="btn btn-primary btn-sm"><i class="fa fa-key"></i> Continue</a>
...
<div class="container-fluid pc-btn" style="display: none">
    <div class="row">
        <div style="margin:30px auto 10px">
            ...
            <a href="<?= Url::to(['index/purchase','app'=>$app->id]) ?>" class="btn btn-primary btn-lg"><i class="fa fa-key"></i> Continue</a>
